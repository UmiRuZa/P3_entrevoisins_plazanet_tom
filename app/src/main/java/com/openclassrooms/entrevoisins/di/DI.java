...
import com.openclassrooms.entrevoisins.service.DummyFavoritesNeighboursApiService;
...
public class DI {
    ...
    private static FavoritesNeighboursApiService favoritesService = new DummyFavoritesNeighboursApiService();
    ...
    /**
     * Get an instance on @{@link FavoritesNeighboursApiService}
     * @return
     */
    public static FavoritesNeighboursApiService getFavoriteNeighbourApiService() {
     ...
     * @return
     */
    public static FavoritesNeighboursApiService getFavoriteNewInstanceApiService() {
        return new DummyFavoritesNeighboursApiService();
    }
}
